...
from kei import __kei__, runtoken, get_from_env, process_fstring, getname, find_method, paths, __py_exec__, dict_diff, error
...
def runtoken(node, env) -> tuple:
    ...
    def runtokentemp() -> tuple:
        ...
        nodetypes['match'] = node_match
        nodetypes['name'] = node_name
        nodetypes['coalesce'] = node_coalesce
        nodetypes['notnullassert'] = node_notnullassert
        nodetypes['index'] = node_index
        nodetypes['trysingle'] = node_trysingle
        nodetypes['slice'] = node_slice
        nodetypes['attr'] = node_attr
        nodetypes['postfix'] = node_postfix
        nodetypes['compoundassign'] = node_compoundassign
        nodetypes['ternary'] = node_ternary
        nodetypes['unternary'] = node_unternary
        nodetypes['listcomp'] = node_listcomp
        nodetypes['unlistcomp'] = node_listcomp
        nodetypes['dictcomp'] = node_dictcomp
        nodetypes['undictcomp'] = node_dictcomp
        nodetypes['binop'] = node_binop
        nodetypes['unary'] = node_unary
        nodetypes['listscope'] = node_listscope
        nodetypes['call'] = node_call
        nodetypes['methodcall'] = node_call
        nodetypes['assign'] = node_assign
        nodetypes['return'] = node_return
        nodetypes['if'] = node_if
        nodetypes['unless'] = node_if
        nodetypes['while'] = node_while
        nodetypes['until'] = node_while
        nodetypes['for'] = node_for
        nodetypes['break'] = node_break
        nodetypes['continue'] = node_break
        nodetypes['function'] = node_block
        nodetypes['class'] = node_class
        nodetypes['import'] = node_import
        nodetypes['fromimport'] = node_fromimport
        nodetypes['del'] = node_del
        nodetypes['raise'] = node_raise
        nodetypes['use'] = node_use
        nodetypes['namespace'] = node_namespace
        nodetypes['with'] = node_with
        nodetypes['lambda'] = node_lambda
        nodetypes['try'] = node_try
        nodetypes['global'] = node_global
        nodetypes['typeassert'] = node_typeassert
